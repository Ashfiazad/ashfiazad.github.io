...
- **Events & News**: Clean interfaces for upcoming/past exhibitions and the latest artist updates.
- **Store Mockup**: A showcase for originals and limited edition prints with interactive toast notifications.
- **Spotlight Alert**: Dismissible top banner for important announcements.
